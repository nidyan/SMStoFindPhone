...
public class SmsRowArrayAdapter extends ArrayAdapter<SmsRow> {
  ...
  public SmsRowArrayAdapter(Context context, int textViewResourceId, List<SmsRow> smsList) {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    View rowView = inflater.inflate(R.layout.main_messages_row, parent, false);
